...
class tm700_rgbd_gym(tm700_possensor_gym):
    ...
    def get_data_path(self):
        """collect paths of .obj files
        return: dictionary of paths {class_name: [list of paths]}
        """
        root = DATA_ROOT
    ...
    def reset(self):
        ...
        for _ in tqdm(range(self.N_DATA_TO_GENERATE)):
            ...
            for _c in chosen_classes:
                objList.append([self.model_paths[_c].pop(), _c])
            self._objectUids, self._objectClasses = self._randomly_place_objects(objList, pos_range)
        ...
        # terminate
        sys.exit('Data generation complete.')

        return np.array(self._observation)


    def _randomly_place_objects(self, objList, pos_range):
        """Randomly place 3 objs on desk.
        """
        objectUids = []
        objectClasses = []
        shift = [0, -0.02, 0]
        ...
        for idx, (obj_path, class_name) in enumerate(objList):
    ...
    def _place_single_object(self, objList):
        """Place single obj on desk.
        """
        objectUids = []
        objectClasses = []
        shift = [0, -0.02, 0]
    ...
    def _get_closeup(self, idx):
        ...
        Save the image and its annotation.
        """
    ...
    def get_img_xy(self, xyz, mat_view, mat_proj, pixel_h, pixel_w):
        """Return the 2D pixel coordinates of objs in a observed image.
        """
    ...
    def get_2d_bbox(self, aabb, mat_view, mat_proj, pixel_h, pixel_w):
        """Return [x_min, y_min, x_max, y_max] of an obj.
        """

#add parent dir to find package. Only needed for source code build, pip install doesn't need it. some code from stable baselines tutorial from https://araffin.github.io/
import os, inspect
...
if MODEL == 'DQN':
  ...
  if ENVIRONMENT in ['rgbd', 'rgb', 'rgbdsparse']:
      model = DQN(LnCnnPolicy, env, verbose=1,
              ...
              gamma=args.discount, learning_rate=args.lr, buffer_size=50000, exploration_fraction=0.1, exploration_final_eps=0.02,
